...
@section('title')
    <h1 class="page-title"> Templates
        <small>Recent Create Template</small>
    </h1>
@endsection
        ...
        <div class="col-md-12">
            <div class="portlet box green">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-gift"></i>Create Template </div>
                </div>
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    <form method="POST" action="{{ route('admin.email.templates.store') }}" id="news_add" enctype="multipart/form-data">
                        {{csrf_field()}}
                        <div class="form-body">
